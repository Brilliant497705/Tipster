      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route
              path="/myprofile"
              element={<MyProfile images={this.state.images} account={this.state.account} tipImageOwner={this.tipImageOwner} />}
            />
            <Route
              path="/explore"
              element={<Explore images={this.state.images} tipImageOwner={this.tipImageOwner} />}
            />
